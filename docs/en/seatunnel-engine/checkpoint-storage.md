...
The client supports multiple authentication mechanisms and can be configured as to which mechanisms to use, and their order of use. Custom implementations of software.amazon.awssdk.auth.credentials.AwsCredentialsProvider
may also be used.
